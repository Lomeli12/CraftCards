...
public class TileEntityStamper extends TileEntity implements IInventory {
        ...
        for(int i = 0; i < 9; i++) {
            if(this.getStackInSlot(i) != null) {
                if(ModLoaded.isModInstalled("EE3")) {
                    if(this.getStackInSlot(i).getItem() instanceof ITransmutationStone)
                        this.getStackInSlot(i).setItemDamage(
                                this.getStackInSlot(i).getItemDamage() + 1);
                }else
    ...
    public void updateEntity() {
        ...
        this.setInventorySlot(10, CraftingManager.getInstance()
                .findMatchingRecipe(ic, this.worldObj));

        if(this.getStackInSlot(10) != null) {
            if(this.getStackInSlot(9) != null
                    && this.getStackInSlot(9).getItem() instanceof ItemCraftCards) {
    ...
    public boolean isItemValidForSlot(int i, ItemStack itemstack) {
        if(itemstack.getItem().equals(this.getStackInSlot(i).getItem())) {
            if(itemstack.getItemDamage() == this.getStackInSlot(i)
                    .getItemDamage()) {
                return true;
            }
        }
