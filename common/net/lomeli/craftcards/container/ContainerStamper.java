...
public class ContainerStamper extends Container {
    ...
    public ContainerStamper(InventoryPlayer inventoryPlayer,
            TileEntityStamper tile) {
        this.tileEntity = tile;

        this.addSlotToContainer(new SlotFakeCraft(inventoryPlayer.player,
                this.tileEntity, this.tileEntity, 10, 112, 35));

        for(int l = 0; l < 3; l++) {
            for(int k1 = 0; k1 < 3; k1++) {
                this.addSlotToContainer(new Slot(this.tileEntity, k1 + l * 3,
                        30 + k1 * 18, 17 + l * 18));
            }
        }
        ...
        this.addSlotToContainer(new SlotCardOutput(this.tileEntity, 11, 148,
                35, tileEntity));
    ...
    public void onCraftMatrixChanged(IInventory iinventory) {
        ...
        this.tileEntity
                .setInventorySlotContents(10, CraftingManager.getInstance()
                        .findMatchingRecipe(ic, this.tileEntity.worldObj));
    }
