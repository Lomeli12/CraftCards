...
public class ModBlocks
{
	...
	{
		stamper = new BlockStamper(ModInts.stamperID).setUnlocalizedName("Stamper")
		...
		GameRegistry.addShapedRecipe(new ItemStack(stamper), new Object[]
			{ "ICI", "STS", "SSS", 'S',Block.cobblestone, 'T',Block.workbench, 
			'I',ModItems.ink, 'C',ModItems.craftCard});
	}
