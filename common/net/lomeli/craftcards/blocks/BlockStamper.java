...
public class BlockStamper extends BlockContainer {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z,
        ...
        if(player.isSneaking())
            ...
            if(!world.isRemote) {
                TileEntityStamper tileEntity = (TileEntityStamper) world
                        .getBlockTileEntity(x, y, z);
                if(tileEntity != null)
                    player.openGui(CraftCards.instance, ModInts.stamperGuiID,
                            world, x, y, z);
            }
        }
        return true;
