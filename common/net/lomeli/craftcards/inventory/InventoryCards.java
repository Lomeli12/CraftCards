...
public class InventoryCards implements IInventory
{
	protected ItemStack[] inventory;
	protected int size;
	protected String uniqueID;
	
	public InventoryCards(ItemStack stack, EntityPlayer player, int par1)
	{
		this.size = par1;
	...
	{
		NBTTagCompound contentTag = ((NBTTagCompound) nbtTagCompound.getTag("cardCardInv"));
		if(contentTag == null)
			return;
	...
	public void writeToNBT(NBTTagCompound myCompound)
    {
        ...
        myCompound.setTag("cardCardInv", contentTag);
